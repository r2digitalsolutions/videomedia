...
<form class="flex flex-col gap-2" use:enhance method="POST" action="?/login">
	<h3 class="mb-12 text-3xl font-extrabold">Sign in</h3>
	...
	<div class="flex flex-col gap-4">
		<div>
			<input
				...
				required
				class="w-full rounded-md bg-gray-100 px-4 py-3.5 text-sm outline-gray-800 autofill:!bg-transparent focus:bg-transparent dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
